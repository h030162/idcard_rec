...
def init_args():
    ...
    parser.add_argument(
        "--rec_char_dict_path", type=str, default="models/rec/dict.txt"
    )
    parser.add_argument("--rec_model_dir", type=str, default="models/rec/idcardrec.onnx")
